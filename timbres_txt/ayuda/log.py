...
class Log:
    ...
    def escribir_titulo(self, titulos, fila, hoja_activa, col_ini = 1):
        """Escribe los titulos en la fila y columna que se indique
        
            fila = 1 para que sea la primera fila"""
    ...
    def escribir_en_hoja(self, contenido_lista, col, hoja_activa, fila_ini=1):
        ...
        los datos siempre se deben meter dentro de una lista
            datos = [info_para_escribir]"""
    ...
    def guardar_archivo_log(self,ruta_guardar):
        """Debe usarse la clase 'asksaveasfilename'"""
