...
class MainWindow(QtWidgets.QMainWindow, Ui_MainWindow):
	...
	def ejecutar_escritura(self):
		ruta_trabajo = self.archivos_trab_ruta.setText()
		ruta_txt_xml = self.rutas_archivos.setText()
		nombre_excel = self.ruta_archivo_excel.setText()
		extencion    = self.extencion_archivo.setText()
